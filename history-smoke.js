...
assert.match(uiSource, /historyHideThreshold: coerceHistoryHideThreshold\(ui\.historyHideThreshold\)/, "grouped-history hiding threshold persists with UI state");
...
assert.match(uiSource, /nextHistoryHideThreshold/, "grouped history hiding button cycles through threshold states");
